    ...
    >
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        >
          ...
          <motion.p
            variants={itemVariants}
            className="text-lg md:text-xl text-textSecondary/80 max-w-2xl mx-auto mb-8 text-balance"
          >
            {personalInfo.bio}
          </motion.p>
          ...
          >
            ...
            <motion.a
              ...
              className="w-full sm:w-auto inline-flex items-center justify-center gap-2 px-8 py-4 glass border border-accent/30 text-textPrimary font-semibold rounded-xl hover:border-accent/60 hover:bg-accent/5 transition-all"
              whileHover={{ scale: 1.02 }}
              whileTap={{ scale: 0.98 }}
            >
              Get In Touch
